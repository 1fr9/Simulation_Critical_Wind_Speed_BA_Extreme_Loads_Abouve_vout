------- OpenFAST INPUT FILE -------------------------------------------
Oberhalb_40mps 630s Seed1
---------------------- SIMULATION CONTROL --------------------------------------
False          Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
         630   TMax            - Total run time (s)
      0.000125   DT              - Recommended module time step (s)
...
"Wind/Seed1/Inflow_40_1.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
